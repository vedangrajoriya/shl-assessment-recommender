...
The solution is designed to be **accurate, explainable, and production-ready**, in alignment with the requirements provided by the SHL AI team.
...
* Query cleaning and lightweight expansion for better intent understanding
...
1. **Query Cleaning & Expansion**
   Important intent keywords (skills, role indicators, behavioral signals) are extracted and appended to improve semantic matching.
...
The repository includes all files required for standard FastAPI deployment workflows.
